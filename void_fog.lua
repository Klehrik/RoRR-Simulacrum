...
function draw_void_fog(x, y)
    ...
    gm.draw_circle(x - gm.camera_get_view_x(cam), y - gm.camera_get_view_y(cam), radius, false)
    ...
    for i = #void_circles, 1, -1 do
        ...
        gm.draw_circle_colour(x, y, radius + r, void_color, void_color, true)
        gm.draw_set_alpha(1)
...
function take_void_damage(actor, x, y)
    ...
    local dist = gm.point_distance(actor.x, actor.y, x, y)
    if dist > radius then
